...
// Import models
const Venue = require('./backend/models/venue.model.js')(sequelize, DataTypes);
const Event = require('./backend/models/event.model.js')(sequelize, DataTypes);
  ...
  try {
    ...
    const sampleVenues = [
      ...
      },
      {
        ...
        longitude: 28.0000,
        capacity: 3000,
        contact_email: 'info@montecasino.co.za',
      ...
      },
      {
        ...
        longitude: 27.9833,
        capacity: 2000,
        contact_email: 'info@goldreefcity.co.za',
      ...
      },
      {
        ...
        longitude: 28.2333,
        capacity: 4000,
        contact_email: 'info@emperorspalace.co.za',
      ...
      },
      {
        ...
        longitude: 27.9500,
        capacity: 1500,
        contact_email: 'info@thedome.co.za',
