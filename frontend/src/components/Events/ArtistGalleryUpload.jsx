// File location: frontend/src/components/Events/ArtistGalleryUpload.jsx
import React, { useState, useCallback } from 'react';
import axios from 'axios';
import API_BASE_URL from '../../api/config';
const API_URL = `${API_BASE_URL}/api`;

export default function ArtistGalleryUpload({ onSave, orgFolder }) {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const uploadPromises = files.map(async (file) => {
        ...
        const response = await axios.post(`${API_URL}/artists/upload-gallery`, formData, {
          headers: {
  ...
  const triggerFileInput = () => {
    document.getElementById('artist-gallery-upload').click();
  };
